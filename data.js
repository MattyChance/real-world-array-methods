...
//is it going to rain? 48hrs
function isRainingIn48h () {
    //need access to icon
    //rawData.hourly.data then it will be an array filled with hourly data for next 48 hours
    return rawData.hourly.icon = 'rain' ? true : false;
}
// console.log(isRainingIn48h(rawData));

//24hrs or 8hrs

function isRainingIn24h () {
    for (var i = 0; i < 8/*24*/; i++) {
        var checkRain = rawData.hourly.data[i];
